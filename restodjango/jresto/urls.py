...
###### API_TEMPLATES ######
urlpatterns += [
    path('api/product/', views_api_templates.GetProductAPIView.as_view(),
         name="get_product"),
...
###### TEMPLATES ADMIN ######
urlpatterns += [
    path('jresto/admin/menu', views_templates_admin.admin_menu, name="admin_menu"),
...
urlpatterns += [
    ...
    path('jresto/register', views_templates_authentication.register_customer,
         name="user_register"),
    path('jresto/login', views_templates_authentication.login_customer,
         name="user_login"),
    path('jresto/logout', views_templates_authentication.logout_customer,
         name="user_logout"),
]
...
###### TEMPLATES CUSTOMER ######
urlpatterns += [
    path('jresto/cart/', views_templates_customer.check_cart, name="check_cart"),
    ...
    path('jresto/checkout/', views_templates_customer.checkout, name="checkout"),
]
